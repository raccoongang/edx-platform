  ...
  render() {
    ...
    return (
      <div className="account-deletion-details">
        ...
        <p className="account-settings-header-subtitle">{ gettext('Please note: Deletion of your account and personal data is permanent and cannot be undone. Docmode will not be able to recover your account or the data that is deleted.') }</p>
        <p className="account-settings-header-subtitle">{ gettext('Once your account is deleted, you cannot use it to take courses on the Docmode.org.') }</p>
        <p
