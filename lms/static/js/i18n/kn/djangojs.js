...
(function (globals) {
  ...
  django.catalog = {
    ...
    "%(earned)s/%(possible)s point (graded)": [
      "%(earned)s/%(possible)s ponto (corrigido)", 
      "%(earned)s/%(possible)s pontos (corrigidos)"
    ], 
    ...
    "%(num_points)s point possible (graded)": [
      "%(num_points)s ponto poss\u00edvel (corrigido)", 
      "%(num_points)s pontos poss\u00edveis (corrigidos)"
    ], 
    "%(num_points)s point possible (graded, results hidden)": [
      "%(num_points)sponto poss\u00edvel (v\u00e1lido para aprova\u00e7\u00e3o no curso, resultados ocultos)", 
      "%(num_points)spontos poss\u00edveis (v\u00e1lidos para aprova\u00e7\u00e3o no curso, resultados ocultos)"
    ], 
    "%(num_points)s point possible (ungraded)": [
      "%(num_points)s ponto poss\u00edvel (n\u00e3o corrigido)", 
      "%(num_points)s pontos poss\u00edveis (n\u00e3o corrigidos)"
    ], 
    "%(num_points)s point possible (ungraded, results hidden)": [
      "%(num_points)s ponto poss\u00edvel (n\u00e3o v\u00e1lido para aprova\u00e7\u00e3o no curso, resultados ocultos)", 
    ...
    "%(num_students)s student": [
      "%(num_students)s aluno", 
      "%(num_students)s alunos"
    ], 
    "%(num_students)s student opened Subsection": [
      "%(num_students)s aluno abriu a Subse\u00e7\u00e3o", 
    ...
    "Back to My Profile": "Voltar ao meu perfil", 
    "Back to My Records": "Voltar para Meus Registros", 
    ...
    "Check the box to remove %(count)s flag.": [
      "Marque a caixa de sele\u00e7\u00e3o para remover %(count)s marcador.", 
      "Marque a caixa de sele\u00e7\u00e3o para remover %(count)s marcadores."
    ], 
    "Check the box to remove %(totalFlags)s flag.": [
      "Marque a caixa de sele\u00e7\u00e3o para remover %(totalFlags)s marcador.", 
      "Marque a caixa de sele\u00e7\u00e3o para remover %(totalFlags)s marcadores."
    ], 
    ...
    "Choose a course run:": "Escolhe a dura\u00e7\u00e3o do curso:", 
    ...
    "Copy this link to share your record with a university, employer, or anyone else of you choosing. Anyone you share this link with will have access to your record forever.": "Copie este link para compartilhar seu registro com uma universidade, empregador ou qualquer outra pessoa que escolher. Qualquer pessoa com quem voc\u00ea compartilhar este link ter\u00e1 acesso ao seu registro para sempre.", 
    ...
    "Create a %(link_start)sMozilla Backpack%(link_end)s account, or log in to your existing account": "Crie uma conta %(link_start)sMozilla Backpack%(link_end)s ou entre na sua conta atual.", 
    ...
    "Discussions add post": "Adicionar postagem de discuss\u00e3o", 
    ...
    "Discussions main page": "P\u00e1gina principal de discuss\u00f5es", 
    "Discussions share ideas and start conversations. (Required)": "As discuss\u00f5es compartilham ideias e iniciam conversas. (Obrigat\u00f3rio)", 
    ...
    "Download": "Baixar", 
    "Download Record": "Baixar registro", 
    ...
    "Editable": "Edit\u00e1vel", 
    "Editing access for: %(title)s": "Editand o acesso para: %(title)s", 
    ...
    "File size must be 10MB or less.": "O tamanho do arquivo deve ser igual ou menor que 10Mb.", 
    ...
    "Highest Grade Earned": "Maior nota conquistada", 
    "Highest Grade Earned: {}": "Maior nota recebida: {}", 
    ...
    "Instead of sharing a link, you can also {start_anchor}directly send your program record to {platform} partners{end_anchor} for credit or application purposes.": "Em vez de compartilhar um link, voc\u00ea tamb\u00e9m pode enviar {start_anchor}diretamente seu registro de programa para o parceiro {platform}{end_anchor} para fins de cr\u00e9dito ou de inscri\u00e7\u00e3o.", 
    ...
    "Loading record link...": "Carregando o link do registro...", 
    ...
    "Masquerading failed": "O mascaramento falhou", 
    ...
    "No records yet. Program records are created once you have earned at least one course certificate in a program.": "Nenhum registro ainda. Os registros do programa s\u00e3o criados quando voc\u00ea recebe pelo menos um certificado de curso em um programa.", 
    ...
    "Not all credit partners are ready to receive records yet": "Nem todos os parceiros de cr\u00e9dito ainda est\u00e3o prontos para receber registros", 
    ...
    "Peer": "Colega", 
    "Pending": "Pendente", 
    "Pesquisa": "Pesquisar todas as postagens", 
    "Photo": "Foto", 
    ...
    "Program Record URL": "URL de registro do programa", 
    "Program Records": "Registros do Programa", 
    ...
    "Question": "Pergunta", 
    "Questions about Learner Records?": "Perguntas sobre o Registro do Estudante?", 
    "Questions raise issues that need answers.": "Perguntas que levantam quest\u00f5es que precisam de respostas.", 
    ...
    "Select organization(s) you wish to send this record to:": "Selecione a(s) organiza\u00e7\u00e3o(\u00f5es) para onde deseja enviar este registro:", 
    ...
    "Self": "Autocorre\u00e7\u00e3o", 
    "Send": "Enviar", 
    "Send Learner Record": "Enviar recorde do estudante", 
    ...
    "Send to {platform} Credit Partner": "Enviar para parceiro de cr\u00e9dito {platform}", 
    "Send to:": "Enviar para:", 
    "Sent By": "Enviado por", 
    "Sent By:": "Enviado por:", 
    ...
    "Share Link to Record": "Compartilhar link para registro", 
    ...
    "Specific Learner": "Estudante espec\u00edfico", 
    ...
    "Successfully copied program record link.": "Link de registro de programa copiado com sucesso.", 
    ...
    "Successfully started task to reset attempts for problem '<%- problem_id %>'. Click the 'Show Task Status' button to see the status of the task.": "A tarefa para repor as tentativas para o problema '<%- problem_id%>' foi iniciada com sucesso. Clique o bot\u00e3o 'Mostrar Status da Tarefa' para ver o status dessa tarefa.", 
    ...
    "There %(articles_plur_verb)s %(cnt)s %(articles_plur)s in this level.": "H\u00e1 %(articles_plur_verb)s %(cnt)s %(articles_plur)s neste n\u00edvel.", 
    ...
    "There was an error when trying to add learners:": [
      "Houve um erro ao tentar adicionar estudantes:", 
    ...
    "This annotation has %(count)s flag.": [
      "Esta anota\u00e7\u00e3o possui %(count)s marcador.", 
      "Esta anota\u00e7\u00e3o possui %(count)s marcadores."
    ], 
    ...
    "To learn more about records you can {start_anchor}read more in our records help area.{end_anchor}": "Para saber mais sobre registros, voc\u00ea pode {start_anchor}ler mais na nossa \u00e1rea de registros de ajuda.{end_anchor}", 
    ...
    "Use the All Topics menu to find specific topics": "Use o menu Todos os T\u00f3picos para encontrar t\u00f3picos espec\u00edficos.", 
    ...
    "Used": "Usado", 
    "Used in {count} unit": [
      "Usado em {count} unidade", 
      "Usado em {count} unidades"
    ], 
    "User": "Usu\u00e1rio", 
    ...
    "Verified Attempts": "Tentativas verificadas", 
    "Verified Attempts: {}": "Tentativas verificadas: {}", 
    ...
    "View Example": "Visualizar exemplo", 
    ...
    "Warning": "Aviso", 
    "Warnings": "Avisos", 
    "We are sending your program record.": "Estamos enviando seu registro do programa.", 
    ...
    "We were unable to create your record link.": "N\u00e3o foi poss\u00edvel criar seu link de registro.", 
    "We were unable to send your program record.": "N\u00e3o foi poss\u00edvel enviar o registro do seu programa.", 
    "We were unable to send your record to {orgs}.  You can attempt to send this record again.  Contact support if this issue persists.": "N\u00e3o foi poss\u00edvel enviar seu registro para {orgs}. Voc\u00ea pode tentar enviar este registro novamente. Entre em contato com o suporte se esse problema persistir.", 
    ...
    "You are currently viewing as: {user}": "Voc\u00ea est\u00e1 vendo no momento como: {user}", 
    ...
    "You can check back in the future or share your record link directly if you need to do so immediately.": "Voc\u00ea pode voltar no futuro ou compartilhar seu link de registro diretamente caso precisar fazer isso imediatamente.", 
    "You can close this window and try again.": "Voc\u00ea pode fechar esta janela e tentar novamente.", 
    "You can directly share your program record with {platform} partners that accept credit for this {type} Program. Once you send your record you cannot unsend it.": "Agora, voc\u00ea pode compartilhar diretamente seu registro de programa com parceiros {platform} que aceitam cr\u00e9dito para este programa {type}. Assim que voc\u00ea enviar seu registro, voc\u00ea n\u00e3o pode desassoci\u00e1-lo.", 
    ...
    "You either do not have permission to masquerade as this user, or the user could not be found.": "Ou voc\u00ea n\u00e3o tem permiss\u00e3o para se passar por esse usu\u00e1rio ou o usu\u00e1rio n\u00e3o foi encontrado.", 
    ...
    "You have not bookmarked any courseware pages yet ": "Voc\u00ea ainda n\u00e3o favoritou nenhuma p\u00e1gina do material did\u00e1tico", 
    ...
    "You have sent your record to {orgs}.  Next, ensure you understand their application process.": "Voc\u00ea enviou seu registro para {orgs}. Em seguida, certifique-se de entender o processo de inscri\u00e7\u00e3o deles.", 
    "You have successfully shared your Learner Record": "Voc\u00ea compartilhou com \u00eaxito seu Registro de Estudante", 
    ...
    "Your file {filename} is too large (max size: {maxSize}MB).": "O arquivo {filename} excede o tamanho m\u00e1ximo de ({maxFileSizeInMBs} MB).", 
    ...
    "discussion posted 10 minutos atr\u00e1s by staff": "discuss\u00e3o postada 10 minutos atr\u00e1s pela equipe", 
    "dragging": "arrastando", 
    ...
    "off": "Desligado", 
    "on": "Ligado", 
    "open discussion": "discuss\u00f5es abertas", 
    ...
    "{firstItems}, and {lastItem}": "{firstItems}, e {lastItem}", 
    "{first} and {second}": "{first} e {second}", 
    "{hours}:{minutes} (current UTC time)": "{hours}:{minutes} (hora UTC atual)", 
    "{label}: {status}": "{label}: {status}", 
    "{name} - Not Yet Available": "{name} - Ainda n\u00e3o dispon\u00edvel", 
    "{name} - Sent": "{name} - Enviados", 
    "{name} Record": "{name} registro", 
    "{numMoved} learner was moved from {prevCohort}": [
      "{numMoved} aluno foi movido do {oldCohort}", 
      "{numMoved} alunos foram movidos do {oldCohort}"
    ], 
    "{numPreassigned} learner was pre-assigned for this cohort. This learner will automatically be added to the cohort when they enroll in the course.": [
      "{numPreassigned} estudante foi pr\u00e9-matriculads para este grupo. Este estudante ser\u00e1 automaticamente adicionado ao grupo quando ele matricular-se no curso.", 
      "{numPreassigned} estudantes foram pr\u00e9-matriculados para este grupo. Estes estudantes ser\u00e3o automaticamente adicionados ao grupo quando eles matricularem-se\u00a0no curso."
    ], 
    ...
    "{type} Program Record": "{type} registro de programa", 
