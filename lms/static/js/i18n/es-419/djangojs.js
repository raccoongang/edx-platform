...
(function (globals) {
  ...
  django.catalog = {
    ...
    " learner is already white listed and not added to the exception list": "estudiante ya est\u00e1 en la lista blanca y no se a\u00f1adi\u00f3 a las excepciones", 
    " learner is not enrolled in course and not added to the exception list": "estudiante no est\u00e1 inscrito en el curso y no se a\u00f1adi\u00f3 a la lista de excepciones", 
    " learner is successfully added to the exception list": "alumno fue agregado a la lista de excepci\u00f3n", 
    " learners are already white listed and not added to the exception list": "estudiantes ya est\u00e1n en la lista blanca y no se a\u00f1adieron a la lista de excepciones", 
    " learners are not enrolled in course and not added to the exception list": "estudiantes no est\u00e1n inscritos en el curso y no se a\u00f1adieron a la lista de excepciones", 
    " learners are successfully added to exception list": "alumnos fueron agregados a la lista de excepciones", 
    " learners do not exist in LMS and not added to the exception list": "estudiantes no existen en el LMS y no se a\u00f1adieron a la lista de excepciones", 
    " record is not in correct format and not added to the exception list": "registro no est\u00e1 en el formato correcto y no se a\u00f1adi\u00f3 a la lista de excepciones", 
    " records are not in correct format and not added to the exception list": "registros no est\u00e1n en el formato correcto y no se a\u00f1adieron a la lista de excepciones", 
    "#Replies": "#Respuestas", 
    ...
    "%(courseName)s Home Page.": "P\u00e1gina de inicio de %(courseName)s.", 
    ...
    "Specify whether discussion topics are divided by cohort": "Especifique si los temas de discusi\u00f3n est\u00e1n divididos por", 
    "Speed": "Velocidad", 
    ...
    "To review student cohort assignments or see the results of uploading a CSV file, download course profile information or cohort results on the {link_start}Data Download{link_end} page.": "Para revisar las asignaciones de grupos de estudiantes o ver los resultados de cargar un archivo de SCV, descargar informaci\u00f3n del perfil del curso o resultados de grupos en la p\u00e1gina de {link_start}descarga de datos{link_end}.", 
