...
(function (globals) {
  ...
  django.catalog = {
    ...
    "%(earned)s/%(possible)s point (ungraded)": [
      "%(earned)s/%(possible)s ponto (n\u00e3o corrigido)", 
      "%(earned)s/%(possible)s pontos (n\u00e3o corrigidos)"
    ], 
    ...
    "Add a clear and descriptive title to encourage participation.": "Adicione um t\u00eetulo claro e descritivo para encorajar a participa\u00e7\u00e3o dos outros colegas.", 
    "Add a comment": "Adicionar coment\u00e1rio", 
    "Add a course": "Adicionar um curso", 
    ...
    "After you publish this program, you cannot add or remove course codes or remove course runs.": "Ap\u00f3s voc\u00ea publicar esse programa, voc\u00ea n\u00e3o poder\u00e1 adicionar ou remover c\u00f3digos do curso ou remover execu\u00e7\u00f5es do curso.", 
    ...
    "Answers to this problem are now shown. Navigate through the problem to review it with answers inline.": "As respostas para este problema agora s\u00e3o mostradas. Navegue pelo problema para rev\u00ea-lo com as respostas inclusas.", 
    ...
    "Average": "M\u00e9dio", 
    "Back to Dashboard": "Voltar ao Painel de controle", 
    ...
    "Choose Course Date": "Escolha uma data para o curso", 
    ...
    "Congratulations! You have earned a certificate for this course.": "Parab\u00e9ns! Voc\u00ea conquistou um certificado para esse curso.", 
    ...
    "Delete this {xblock_type} (and prerequisite)?": "Delete esse {xblock_type} (e pr\u00e9-requisitos)", 
    ...
    "No results found for {original_query}. ": "Nenhum resultado encontrado para {original_query}. ", 
    ...
    "Please select a course date": "Por favor, selecione uma data do curso", 
    "Please select a file in .srt format.": "Selecione um arquivo no formato .srt.", 
    "Please select a valid organization.": "Por favor, selecione uma organiza\u00e7\u00e3o v\u00e1lida.", 
    ...
    "Program Certificates": "Certificados do Programa", 
    "Programs": "Programas", 
    ...
    "Publish this program?": "Publicar esse programa?", 
    ...
    "Question": "Pergunta", 
    "Questions raise issues that need answers. Discussions share ideas and start conversations.": "Perguntas levantam quest\u00f5es que precisam de respostas. Discuss\u00f5es compartilham ideias e iniciam conversas.", 
    ...
    "Select Course Run": "Selecione in\u00edcio do curso", 
    ...
    "Show Comment (%(num_comments)s)": [
      "Exibir Coment\u00e1rio (%(num_comments)s)", 
      "Exibir Coment\u00e1rios (%(num_comments)s)"
    ], 
    ...
    "This content group is not in use. Add a content group to any unit from the {linkStart}Course Outline{linkEnd}.": "Este grupo de conte\u00fado n\u00e3o est\u00e1 em uso. Adicione um grupo de conte\u00fado para qualquer unidade do {linkStart}Esbo\u00e7o do curso{linkEnd}.", 
    ...
    "This discussion could not be loaded. Refresh the page and try again.": "Esta discuss\u00e3o n\u00e3o p\u00f4de ser carregada. Recarregue a p\u00e1gina e tente novamente.", 
    ...
    "View Certificate": "Visualizar Certificado", 
    ...
    "You have earned certificates in %(completed_courses)s of the %(total_courses)s courses so far.": "Voc\u00ea conquistou certificados em %(completed_courses)s num total de %(total_courses)s.", 
    ...
    "You need a certificate in this course to be eligible for a program certificate.": "Voc\u00ea precisa de um certificado nesse curso para estar eleg\u00edvel para o programa de certificado", 
    ...
    "Your question or idea": "Sua pergunta ou opini\u00e3o", 
    "Your request could not be completed due to a server problem. Reload the page": "Seu pedido n\u00e3o p\u00f4de ser conclu\u00eddo devido a um problema no servidor. Recarregue a p\u00e1gina", 
    ...
    "{0} is invalid": "{0} \u00e9 inv\u00e1lido", 
    "{0} is required": "{0} \u00e9 obrigat\u00f3rio.", 
    "{0} must be a number": "{0} deve ser um n\u00famero", 
    "{0} must be a valid email": "{0} deve ser um email v\u00e1lido", 
    "{0} must be a valid url": "{0} deve ser uma URL v\u00e1lida", 
    "{0} must be accepted": "{0} deve ser aceito.", 
    "{0} must be at least {1} characters": "{0} deve ter pelo menos {1} caracteres", 
    "{0} must be at most {1} characters": "{0} deve ter pelo menos {1} caracteres", 
    "{0} must be between {1} and {2}": "{0} deve estar entre {1} e {2}", 
    "{0} must be between {1} and {2} characters": "{0} deve ter entre {1} e {2} caracteres", 
    "{0} must be greater than or equal to {1}": "{0} deve ser maior ou igual a {1}", 
    "{0} must be less than or equal to {1}": "{0} deve ser menor ou igual a {1}", 
    "{0} must be one of: {1}": "{0} deve ser um de: {1}", 
    "{0} must be the same as {1}": "{0} deve ser o mesmo que {1}", 
    "{0} must be {1} characters": "{0} deve ter {1} caracteres", 
    "{0} must only contain digits": "{0} deve conter apenas d\u00edgitos", 
