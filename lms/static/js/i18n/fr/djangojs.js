...
(function (globals) {
  ...
  django.catalog = {
    ...
    "The selected image must be larger than {minFileSizeInKB}.": "L'image s\u00e9lectionn\u00e9e doit faire au moins {maxFileSizeInMB}.", 
    ...
    "{htmlStart}Want to change your email, name, or password instead?{htmlEnd}": "{htmlStart} voulez-vouas permuter votre email, nom, ou mot de passe?{htmlEnd}", 
    ...
    "{strongStart}Warning: Account deletion is permanent.{strongEnd} Please read the above carefully before proceeding. This is an irreversible action, and {strongStart}you will no longer be able to use the same email on edX.{strongEnd}": "{strongStart}Attention: La suppression du compte est d\u00e9finitive.{strongEnd} Veuillez lire attentivement, pr\u00e9c\u00e9demment, avant de proc\u00e9der. C'est une action irr\u00e9versible, et {strongStart}vous ne serez plus capable d'utiliser le m\u00eame e-mail sur Edx.{strongEnd}", 
