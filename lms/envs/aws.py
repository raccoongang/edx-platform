...
ARROW_CUSTOMER_SITE_COUNTRY_LIST = ENV_TOKENS.get('ARROW_CUSTOMER_SITE_COUNTRY_LIST', ARROW_CUSTOMER_SITE_COUNTRY_LIST)
ARROW_CUSTOMER_SITE_URL = ENV_TOKENS.get('ARROW_CUSTOMER_SITE_URL', ARROW_CUSTOMER_SITE_URL)
#### RaccoonGang ####

# Courses categorization feature
HOMEPAGE_COURSE_MAX = ENV_TOKENS.get('HOMEPAGE_COURSE_MAX', HOMEPAGE_COURSE_MAX)
CATEGORIES = ENV_TOKENS.get("CATEGORIES", {})
