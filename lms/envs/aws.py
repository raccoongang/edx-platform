...
SOCIAL_AUTH_EXCLUDE_URL_PATTERN = ENV_TOKENS.get('SOCIAL_AUTH_EXCLUDE_URL_PATTERN', '^/admin/')

ENABLE_ADDITIONAL_MIDDLEWARE_CLASSES = ENV_TOKENS.get('ENABLE_ADDITIONAL_MIDDLEWARE_CLASSES', False)

if ENABLE_ADDITIONAL_MIDDLEWARE_CLASSES:
    MIDDLEWARE_CLASSES += tuple(ENV_TOKENS.get('ADDITIONAL_MIDDLEWARE_CLASSES', ()))
