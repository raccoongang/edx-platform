...
EMAIL_HOST_USER = AUTH_TOKENS.get('EMAIL_HOST_USER', '').encode('ascii', 'ignore')  # django default is ''
EMAIL_HOST_PASSWORD = AUTH_TOKENS.get('EMAIL_HOST_PASSWORD', '').encode('ascii', 'ignore')  # django default is ''
