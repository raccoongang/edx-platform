...
ZOHO_ENDPOINT_PREFIX = ENV_TOKENS["ZOHO_ENDPOINT_PREFIX"]
ZOHO_RESPONSE_SIZE = ENV_TOKENS["ZOHO_RESPONSE_SIZE"]
ZOHO_TOKEN = ENV_TOKENS["ZOHO_TOKEN"]

ZAPIER_ENROLLMENT_URL = ENV_TOKENS["ZAPIER_ENROLLMENT_URL"]
ZAPIER_UNENROLLMENT_URL = ENV_TOKENS["ZAPIER_UNENROLLMENT_URL"]
ZAPIER_LOGIN_REMINDER = ENV_TOKENS["ZAPIER_LOGIN_REMINDER"]
