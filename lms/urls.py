...
urlpatterns = (
    ...
    url(r'^subscribe_platform_updates$', 'student.views.subscribe_platform_updates', name='subscribe_platform_updates'),
    ...
    url(r'^edeos/', include('edeos.urls', namespace="edeos")),
