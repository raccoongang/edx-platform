                           ...
                           try:
                               with transaction.atomic():
                                   ...
                                   if api_data:
                                       ...
                                       self.stdout.write(
                                           u'User with id {} updated: full_name {}, first_name {}, last_name {}'.format(
                                               social_auth_user.user.id, full_name, first_name, last_name
                                           )
                                       )
                                   else:
                                       self.stdout.write(
                                           u'Remote service returned empty response for user:id={}, uid={}'.format(
                               ...
                               if hasattr(e, 'message') and e.message:
                                   ...
                                   error_string = str(e)
                               self.stdout.write(
                                   u'User with id {} not updated. Exception {}'.format(
