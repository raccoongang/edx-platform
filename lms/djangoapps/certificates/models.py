...
class CertificateStatuses(object):
    ...
    readable_statuses = {
        downloadable: _("already received"),
        notpassing: _("didn't receive"),
        error: _("error states"),
        audit_passing: _("audit passing states"),
        audit_notpassing: _("audit not passing states"),
    }
...
def generate_pdf(sender, instance, **kwargs):
    ...
    html_cert_url = '{}{}'.format(settings.FEATURES.get('LOCAL_LMS_URL', 'https://{}'.format(settings.SITE_NAME)), reverse('certificates:token_html_view', kwargs=kwargs))
