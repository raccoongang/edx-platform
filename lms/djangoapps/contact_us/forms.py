...
class contact_us_frm(forms.Form):
	...
	# 	inquiry_type = self.cleaned_data["inquiry_type"]
	# 	message = re.sub(r'^https?:\/\/.*[\r\n]*', '', self.cleaned_data["message"], flags=re.MULTILINE)

	# class Meta(object):
	# 	model = contact_us_form
	# 	fields = ('name','emailid','phone','inquiry_type','message')
