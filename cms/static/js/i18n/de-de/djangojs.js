...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "%(num_points)s point possible (graded, results hidden)": [
      "%(num_points)sPunkt m\u00f6glich (Benotet, Ergebnisse nicht sichtbar)", 
      "%(num_points)sPunkte m\u00f6glich (Benotet, Ergebnisse nicht sichtbar)"
    ], 
    ...
    "%(num_points)s point possible (ungraded, results hidden)": [
      "%(num_points)sPunkt m\u00f6glich (Unbenotet, Ergebnisse nicht sichtbar)", 
      "%(num_points)sPunkte m\u00f6glich (Unbenotet, Ergebnisse nicht sichtbar)"
    ], 
    ...
    "(Self-paced) Started {start}": "(Eigenverantwortlich) Hat begonnen {start}", 
    ...
    "Add Cohort": "Grossgruppe hinzuf\u00fcgen", 
    ...
    "All learners in the {track_name} track": "Alle Lernenden im Track {track_name}", 
    ...
    "Already have an {platformName} account?": "Haben Sie bereits ein {platformName}-Konto?", 
    ...
    "Any divided discussion topics are divided based on cohort.": "Alle geteilten Diskussionsthemen werden nach Kohorte gegliedert.", 
    ...
    "Are you sure you want to remove this transcript?": "Sind Sie sicher, dass Sie das Transskript entfernen m\u00f6chten?", 
    ...
    "Are you sure you want to unenroll from the verified %(certNameLong)s  track of %(courseName)s  (%(courseNumber)s)?": "Sind Sie sicher, dass Sie sich aus dem zertifizierten  %(certNameLong)s  f\u00fcr den Kurs %(courseName)s  (%(courseNumber)s)?", 
    ...
    "Certificate has been successfully invalidated for <%= user %>.": "Das Zertifikat f\u00fcr <%= user %> wurde erfolgreich entwertet.", 
    "Certificate name is required.": "Zertifikatname wird ben\u00f6tigt.", 
    "Certificate of <%= user %> has already been invalidated. Please check your spelling and retry.": "Das Zertifikat f\u00fcr <%= user %> wurde bereits entwertet. Bitte kontrollieren Sie Ihre Eingabe.", 
    "Change": "\u00c4nderung", 
    ...
    "Choose One": "Eine ausw\u00e4hlen", 
    "Choose a .csv file": "W\u00e4hlen Sie eine .csv-Datei aus", 
    "Choose a Date": "Datum w\u00e4hlen", 
    "Choose a Time": "Uhrzeit w\u00e4hlen", 
    "Choose a content group to associate": "W\u00e4hle eine Inhaltsgruppe", 
    "Choose a location to move your component to": "W\u00e4hlen Sie einen Ort, wo Sie die Komponente hinbewegen m\u00f6chten", 
    ...
    "Cohorts Enabled": "Kohort erlaubt", 
    ...
    "Could not find a user with username or email address '<%- identifier %>'.": "Ein Benutzer mit Benutzername oder E-Mail-Adresse '<%- Identifikator %>' konnte nicht gefunden werden.", 
    ...
    "Create an {platform} account": "Erstellen Sie ein {platform} Account", 
    ...
    "Discussion topics in the course are not divided.": "Die Diskussionsthemen im Kurs sind nicht geteilt.", 
    ...
    "Enter the username or email address of each learner that you want to add as an exception.": "Geben Sie in die Eingabefelder den Benutzernamen oder die E-Mail Adresse des jeweiligen Teilnehmers ein, welchen Sie zur Ausnahmeliste hinzuf\u00fcgen m\u00f6chten.", 
    ...
    "Error deleting entrance exam state for student '{student_id}'. Make sure student identifier is correct.": "Fehler beim L\u00f6schen des Status der Aufnahmepr\u00fcfung f\u00fcr den Teilnehmer '{student_id}'. Vergewissern Sie sich, dass die Teilnehmer ID korrekt ist.", 
    ...
    "Error generating student profile information. Please try again.": "Es ist ein Fehler beim Laden der Teilnehmerinformationen aufgetreten. Bitte versuchen Sie es erneut.", 
    ...
    "Error resetting entrance exam attempts for student '{student_id}'. Make sure student identifier is correct.": "Fehler beim zur\u00fccksetzen der Pr\u00fcfungsversuche des Teilnehmers '{student_id}'. Stellen Sie sicher, dass die Teilnehmer ID korrekt ist.", 
    ...
    "Error starting a task to rescore entrance exam for student '{student_id}'. Make sure that entrance exam has problems in it and student identifier is correct.": "Fehler beim Starten einer Aufgabe zur Neubewertung der Aufnahmepr\u00fcfung f\u00fcr den Teilnehmer '{student_id}'. Vergewissern Sie sich, dass die Aufnahmepr\u00fcfung Probleme beinhaltet und die Teilnehmer ID korrekt ist.", 
    "Error starting a task to rescore problem '<%- problem_id %>' for student '<%- student_id %>'. Make sure that the the problem and student identifiers are complete and correct.": "Fehler beim Starten einer Aufgabe, um das Problem '<%- problem_id %>' f\u00fcr den Teilnehmer '<%- student_id %>' neuzubewerten. Stellen Sie sicher, dass die Problem- und Teilnehmercodes vollst\u00e4ndig und korrekt sind.", 
    "Error starting a task to rescore problem '<%- problem_id %>'. Make sure that the problem identifier is complete and correct.": "Fehler beim Starten einer Aufgabe zur Neubewertung des Problems '<%- problem_id %>'. Stellen Sie sicher, dass der Problemcode vollst\u00e4ndig und korrekt ist.", 
    ...
    "Error: User '<%- username %>' has not yet activated their account. Users must create and activate their accounts before they can be assigned a role.": "Fehler: Der Benutzer '<%- username %>' hat sein Konto noch nicht aktiviert. Benutzer m\u00fcssen ihre Konten anlegen und aktivieren, bevor ihnen eine Rolle zugewiesen werden kann.", 
    ...
    "Failed to rescore problem for user.": "Das Problem konnte f\u00fcr den Benutzer nicht behoben werden.", 
    "Failed to rescore problem to improve score for user.": "Die Neubewertung des Problems zur Verbesserung der Punktzahl des Benutzers fehlgeschlagen.", 
    "Failed to reset attempts for user.": "Die Freiversuche f\u00fcr diesen Teilnehmer konnten nicht zur\u00fcckgesetzt werden.", 
    "February": "Februar", 
    ...
    "Go to Dashboard": "Gehe zur \u00dcbersichtsseite", 
    "Go to my Dashboard": "Zu meiner \u00dcbersichtsseite", 
    ...
    "Highlight {highlight_index}": "Hervorheben {highlight_index}", 
    ...
    "ID": "ID", 
    "ID-Verification is not required for this Professional Education course.": "ID-Verification ist f\u00fcr diesen Kurs nicht erforderlich.", 
    ...
    "If you are unable to access your account contact us via email using {email}.": "Wenn Sie keinen Zugang zu Ihren Account haben, kontaktieren Sie uns via E-Mail {email}.", 
    ...
    "If you don't verify your identity now, you can still explore your course from your dashboard. You will receive periodic reminders from {platformName} to verify your identity.": "Wenn Sie Ihre Identit\u00e4t jetzt nicht verifizieren, k\u00f6nnen Sie Ihren Kurs trotzdem \u00fcber Ihr Dashboard erkunden. Sie erhalten von {platformName} regelm\u00e4\u00dfig Erinnerungen, um Ihre Identit\u00e4t zu \u00fcberpr\u00fcfen.", 
    ...
    "If you make significant changes, make sure you notify members of the team before making these changes.": "Wenn Sie wesentliche \u00c4nderungen vornehmen, informieren Sie die Mitglieder des Teams, bevor Sie diese \u00c4nderungen vornehmen.", 
    ...
    "If you use the Advanced Editor, this problem will be converted to XML and you will not be able to return to the Simple Editor Interface.\n\nProceed to the Advanced Editor and convert this problem to XML?": "Wenn Sie den erweiterten Editor verwenden, wird dieses Problem in XML umgewandelt und Sie k\u00f6nnen nicht zur einfachen Editor-Oberfl\u00e4che zur\u00fcckkehren.\n\nFahren Sie mit dem erweiterten Editor fort und konvertieren Sie dieses Problem in XML?", 
    "Ignore": "Ignorieren", 
    ...
    "In the {linkStart}Course Outline{linkEnd}, use this group to control access to a component.": "Verwenden Sie diese Funktion in der {linkStart}Kurs\u00fcbersicht{linkEnde}, um den Zugriff auf eine Komponente zu steuern.", 
    ...
    "Learners do not see whether their answers to assessments were correct or incorrect, nor the score received, until after the due date for the subsection has passed.": "Nutzer sehen erst die Auswertung ihrer Antworten, nach Ablauf der Laufzeit des Unterabschnitt.", 
    ...
    "Links should be unique.": "Links sollten einzigartig sein.", 
    ...
    "Maximum": "Maximal", 
    "Maximum file size: {maxFileSize} GB": "Maximale Dateigr\u00f6\u00dfe betr\u00e4gt: {maxDateiGr\u00f6\u00dfe} GB", 
    "May": "Mai", 
    ...
    "Please add a photo of the instructor (Note: only JPEG or PNG format supported)": "Bitte f\u00fcgen Sie ein Bild des Dozenten hinzu (beachten Sie: Nur JPEG oder PNG Dateiformate werden hier unterst\u00fctzt)", 
    ...
    "Required": "Ben\u00f6tigt", 
    "Required field.": "Erforderliches Feld.", 
    "Rescore problem '<%- problem_id %>' for all students?": "Problem '<%- problem_id %>' f\u00fcr alle Lernenden neu bewerten?", 
    ...
    "Save changes": "\u00c4nderungen speichern", 
    "Saved cohort": "gespeicherte Kohorte", 
    "Saving": "Speichert", 
    ...
    "Search the {platform} Help Center": "Durchsuchen Sie das Hilfecenter der  {platform}.", 
    "Section": "Abschnitt", 
    ...
    "Select the course-wide discussion topics that you want to divide.": "W\u00e4hlen Sie die kursweiten Diskussionsthemen aus, die Sie einteilen m\u00f6chten.", 
    ...
    "Send push notification to mobile apps": "Pushbenachrichtigung zur mobile App zulassen", 
    "Send to:": "Senden an:", 
    "Sent By": "Absender", 
    "Sent By:": "Absender:", 
    "Sent To": "Gesendet an", 
    ...
    "Sign in to {platform} so we can help you better.": "Melden Sie sich bei {platform} an, damit wir Ihnen bei anderen Fragen helfen k\u00f6nnen.", 
    ...
    "Some images in this post have been omitted": "Einige Bilder dieses Posts wurden weggelassen.", 
    ...
    "Start": "Beginn", 
    "Start Date": "Zeitpunkt des Starts", 
    ...
    "The file must be at least {size} in size.": "Die Datei muss mindestens {size} gro\u00df sein.", 
    ...
    "The general category for this type of assignment, for example, Homework or Midterm Exam. This name is visible to learners.": "Die allgemeine Kategorie f\u00fcr diese Art von Aufgaben, z.B. Hausaufgaben oder Zwischenpr\u00fcfungen. Dieser Name ist f\u00fcr die Lernenden sichtbar.", 
    ...
    "The name that identifies you on {platform_name}. You cannot change your username.": "Dies ist Ihr Benutzername auf der {platform_name} Plattform. Diesen k\u00f6nnen Sie nicht mehr \u00e4ndern.", 
    "The name that is used for ID verification and that appears on your certificates.": "Dieser Name wird f\u00fcr Ihre ID Verifikation genutzt und erscheint auf Ihren Zertifikaten.", 
    ...
    "The selected image must be larger than {minFileSizeInKB}.": "Das ausgew\u00e4hlte Bild muss gr\u00f6\u00dfer sein als {minFileSizeInKB}.", 
    ...
    "The weight of all assignments of this type as a percentage of the total grade, for example, 40. Do not include the percent symbol.": "Das Gewicht aller Aufgaben dieser Art in Prozent der Gesamtnote, z.B. 40. Das Prozentsymbol darf nicht enthalten sein.", 
    ...
    "There was an error changing the user's role": "Es ist ein Fehler beim \u00e4ndern der Teilnehmerrolle aufgetreten.", 
    ...
    "This group no longer exists. Choose another group or do not restrict access to this unit.": "Diese Gruppe existiert nicht mehr. W\u00e4hlen Sie eine andere Gruppe oder beschr\u00e4nken Sie den Zugriff auf dieses Ger\u00e4t nicht.", 
    ...
    "This post could not be unflagged for abuse. Refresh the page and try again.": "Dieser Beitrag konnte nicht wegen Missbrauchs entflaggt werden. Aktualisieren Sie die Seite und versuchen Sie es erneut.", 
    ...
    "This response could not be marked as an answer. Refresh the page and try again.": "Ihre Antwort konnte nicht als Antwort markiert werden. Bitte laden Sie die Seite neu.", 
    ...
    "To invalidate a certificate for a particular learner, add the username or email address below.": "F\u00fcgen Sie \u00fcber die untenstehenden Eingabefelder die Teilnehmer hinzu, f\u00fcr welche Sie die Zertifikate ung\u00fcltig machen m\u00f6chten.", 
    ...
    "Turn on closed captioning": "Seitennummerierung", 
    ...
    "Upload Signature Image": "Bild der Unterschrift hinzuf\u00fcgen", 
    "Upload Videos": "Videos hochladen", 
    "Upload a CSV file": "Hochladen einer CSV-Datei", 
    "Upload a comma separated values (.csv) file that contains the usernames or email addresses of learners who have been given exceptions. Include the username or email address in the first comma separated field. You can include an optional note describing the reason for the exception in the second comma separated field.": "Laden Sie eine (.csv) Datei hoch, in welcher die E-Mail Adressen oder der Benutzername der jeweiligen Teilnehmer, welche Sie zu der Ausnahmeliste hinzuf\u00fcgen m\u00f6chten, eingetragen sind. Bitte beachten Sie hierbei, dass die Eintr\u00e4ge durch Komma separiert werden.  ", 
    ...
    "Upload is in progress. To avoid errors, stay on this page until the process is complete.": "Wird hochgeladen. Um Fehler vorzubeugen, warten Sie bis der Vorgang abgeschlossen ist.", 
    ...
    "Video Source Language": "Originalsprache des Videos", 
    ...
    "View Course": "\u00dcbersicht der Kurse", 
    ...
    "We've sent a message to {email}. Click the link in the message to reset your password. Didn't receive the message? Contact {anchorStart}technical support{anchorEnd}.": "Wir haben Ihnen eine E-Mail zu {email} gesendet. Klicken Sie auf den Link in der E-Mail, um Ihr Passwort zur\u00fcckzusetzen. Solten Sie keine Nachricht erhalten haben, kantaktieren Sie unseren {anchorStart}technischen support{anchorEnd}.", 
    "Web:": "Web:", 
    "Webcam": "Webcam", 
    "Weekly Highlight Emails": "w\u00f6chentliche E-Mails \u00fcber Neuigkeiten", 
    "Weight of Total Grade": "Gewichtung der Gesamtnote", 
    "We\u2019re sorry to see you go!": "Es tut uns leid, dass Sie Ihr Account l\u00f6schen m\u00f6chten!", 
    ...
    "Words: {0}": "W\u00f6rter: {0}", 
    "Would you like to sign in using your %(providerName)s credentials?": "W\u00fcrden Sie sich gerne mit Ihren %(providerName)s Anmeldedaten anmelden?", 
    ...
    "You can link your social media accounts to simplify signing in to {platform_name}.": "Sie k\u00f6nnen Ihre Social-Media Accounts verlinken, um das Anmelden bei der {platform_name} Plattform zu vereinfachen.", 
    ...
    "You can pay now even if you don't have the following items available, but you will need to have these by {date} to qualify to earn a Verified Certificate.": "Sie k\u00f6nnen jetzt bezahlen, auch wenn Sie die folgenden Elemente nicht zur Verf\u00fcgung haben, aber Sie m\u00fcssen diese bis zum {Datum} haben, um sich f\u00fcr ein verifiziertes Zertifikat zu qualifizieren.", 
    ...
    "You could not be subscribed to this post. Refresh the page and try again.": "Sie konnten nicht zu diesem Post als Subscriber hinzugef\u00fcgt werden. Laden Sie bitte die Seite erneut und versuchen Sie es noch einmal.", 
    ...
    "You receive messages from {platform_name} and course teams at this address.": "Auf diese E-Mail Adresse werden Sie alle Benachrichtigungen und Neuigkeiten der {platform_name}\u00a0Plattform zugesandt bekommen.", 
    ...
    "Your request could not be completed due to a server problem. Reload the page and try again. If the issue persists, click the Help tab to report the problem.": "Ihre Anfrage konnte aufgrund eines Serverproblems nicht bearbeitet werden. Laden Sie die Seite neu und versuchen Sie es erneut. Wenn das Problem weiterhin besteht, klicken Sie auf die Registerkarte Hilfe, um das Problem zu melden.", 
    ...
    "Your request could not be completed. Reload the page and try again. If the issue persists, click the Help tab to report the problem.": "Ihre Anfrage konnte nicht bearbeitet werden. Laden Sie die Seite neu und versuchen Sie es erneut. Wenn das Problem weiterhin besteht, klicken Sie auf die Registerkarte Hilfe, um das Problem zu melden.", 
    ...
    "discussion": "Diskussion", 
    "discussion posted %(time_ago)s by %(author)s": "Diskussion wurde %(time_ago)s er\u00f6ffnet durch  %(author)s", 
    "dragging": "ziehen", 
