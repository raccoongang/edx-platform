...
export default class InteractiveSimulation extends React.Component{

    componentDidMount() {
        this.props.initTinyMCE('#InteractiveSimulation');
    }
        ...
        return (
            <div className="author-block__wrapper">
                <div className="author-block__content">
                    ...
                    <textarea id="InteractiveSimulation" cols="30" rows="10"></textarea>
