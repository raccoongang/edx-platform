...
urlpatterns = [
    ...
    url(r'^xblock/hera_template_create_handler$', contentstore.views.hera_template_create_handler,
        name='hera_template_create_handler'),
    url(r'^xblock/hera_template_changes_handler$', contentstore.views.hera_template_changes_handler,
        name='hera_template_changes_handler'),
