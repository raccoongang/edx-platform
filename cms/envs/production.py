...
# Studio SSO login through the LMS settings
SOCIAL_AUTH_EDX_OAUTH2_KEY = ENV_TOKENS.get('SOCIAL_AUTH_EDX_OAUTH2_KEY')
SOCIAL_AUTH_EDX_OAUTH2_SECRET = ENV_TOKENS.get('SOCIAL_AUTH_EDX_OAUTH2_SECRET')
