...
EMAIL_USE_SSL = ENV_TOKENS.get('EMAIL_USE_SSL', EMAIL_USE_SSL)
...
#RACCOONGANG
MEDIA_ROOT = ENV_TOKENS.get('MEDIA_ROOT', '')
MEDIA_URL = ENV_TOKENS.get('MEDIA_URL', '')
...
MAX_ASSET_UPLOAD_FILE_SIZE_IN_MB = FEATURES.get("MAX_ASSET_UPLOAD_FILE_SIZE_IN_MB", 700)
