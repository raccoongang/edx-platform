...
if AUTH_TOKENS.get('DEFAULT_FILE_STORAGE'):
    ...
    os.environ["AZURE_STORAGE_ACCOUNT"] = AZURE_ACCOUNT_NAME
    os.environ["AZURE_STORAGE_ACCESS_KEY"] = AZURE_ACCOUNT_KEY
else:
...
MINIMAL_GRADING_REACHED_NOTIFICATION_ROUTING_KEY = ENV_TOKENS.get(
    'MINIMAL_GRADING_REACHED_NOTIFICATION_ROUTING_KEY', LOW_PRIORITY_QUEUE,
)
