...
from .views import CreateCourseToLibraryImportView, ImportBlocksView, GetCourseStructureToLibraryImportView

app_name = 'v0'
urlpatterns = [
    path('import_blocks/', ImportBlocksView.as_view(), name='import_blocks'),
    path('create_import/<str:lib_key_str>/', CreateCourseToLibraryImportView.as_view(), name='create_import'),
