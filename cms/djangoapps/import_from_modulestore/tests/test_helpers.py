...
class TestImportClient(TestCase):
    ...
    def setUp(self):
        ...
        self.staged_content = mock.MagicMock(spec=StagedContent)
    ...
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.UsageKey.from_string')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.etree.fromstring')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.get_block_to_import')
    ...
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.etree.fromstring')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.get_block_to_import')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.ImportClient._import_complicated_child')
    def test_import_from_staged_content_success(self, mock_import_child, mock_get_block, mock_fromstring, mock_usage_key):
    ...
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.get_or_create_publishable_entity_mapping')
    ...
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.UsageKey.from_string')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.get_usage_key_string_from_staged_content')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.ImportClient._import_child_block')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.ImportClient._import_simple_block')
    def test_process_import_complicated_block(self, mock_import_simple, mock_import_child, mock_get_key, mock_usage_key):
    ...
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.authoring_api.create_next_container_version')
    ...
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.authoring_api.get_components')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.api.library_component_usage_key')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.api.set_library_block_olx')
    ...
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.content_staging_api.get_staged_content_static_file_data')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.authoring_api.get_or_create_media_type')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.authoring_api.get_or_create_file_content')
    @mock.patch('cms.djangoapps.import_from_modulestore.helpers.authoring_api.create_component_version_content')
    def test_process_staged_content_files(self, mock_create_version_content, mock_get_file_content, 
                                            mock_get_media_type, mock_get_file_data):
