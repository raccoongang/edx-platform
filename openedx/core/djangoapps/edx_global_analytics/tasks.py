...
def collect_stats():
    ...
    set_last_sent_date(result, statistics_level, access_token, data)


def set_last_sent_date(result, statistics_level, token, data):
    """
    ...
    """
    if result != True or statistics_level != 'enthusiast':  # If http request is failed or statistics level is paranoid
        return
