...
WAFFLE_FLAG_NAMESPACE = 'schedules'
...
DEBUG_MESSAGE_WAFFLE_FLAG = WaffleFlag(f'{WAFFLE_FLAG_NAMESPACE}.enable_debugging', __name__)
...
_EXTERNAL_COURSE_UPDATES_FLAG = ExperimentWaffleFlag(  # lint-amnesty, pylint: disable=toggle-missing-annotation
    f'{WAFFLE_FLAG_NAMESPACE}.external_updates', __name__,
