...
REQUIRED_FIELD_INSTRUCTOR_MSG = _(u"Select your teacher.")
REQUIRED_FIELD_PARENT_EMAIL_MSG = _(u"Enter parent email address.")
REQUIRED_FIELD_PARENT_EMAIL_EQUALS_USER_EMAIL_MSG = _(u"Your email and parent's one can not be the same")
REQUIRED_FIELD_PARENT_PHONE_MSG = _(u"Enter parent phone number.")
REQUIRED_FIELD_PHONE_MSG = _(u"Enter your phone number.")
REQUIRED_FIELD_PHONE_EQUALS_PARENT_PHONE_MSG = _(u"Your phone number and parent's one can not be the same")
