...
REQUIRED_FIELD_PARENT_EMAIL_EQUALS_USER_EMAIL_MSG = _(u"Student and parent emails must be different.")
REQUIRED_FIELD_PARENT_PHONE_MSG = _(u"Enter parent phone number.")
REQUIRED_FIELD_PHONE_MSG = _(u"Enter your phone number.")
REQUIRED_FIELD_PHONE_EQUALS_PARENT_PHONE_MSG = _(u"Student and parent phone numbers must be different.")
