...
from .views import CalendarTabFragmentView, InitCalendarView, events_view, dataprocessor_view

urlpatterns = patterns(
    'calendar_tab.views',
    url(r"^dataprocessor/$", dataprocessor_view, name="dataprocessor"),
    url(r"^$", login_required(CalendarTabFragmentView.as_view()), name="calendar_view"),
