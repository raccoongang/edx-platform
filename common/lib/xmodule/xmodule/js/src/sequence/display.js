    ...
    this.Sequence = (function() {
        ...
        Sequence.prototype.goto = function(event) {
            ...
            // Tab links generated by backend template
                ...
                var currentPosition = $(event.currentTarget).closest('#sequence-list').find('button.nav-item.active').data('element');
                var targetPosition = $(event.currentTarget).data('element');
