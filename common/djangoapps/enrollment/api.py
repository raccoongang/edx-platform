...
def add_enrollment(user_id, course_id, mode=None, is_active=True, enrollment_attributes=None, due_date=None):
    ...
    enrollment = _data_api().create_course_enrollment(user_id, course_id, mode, is_active, due_date)
