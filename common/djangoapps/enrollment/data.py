...
def create_course_enrollment(username, course_id, mode, is_active, due_date=None):
    ...
    try:
        enrollment = CourseEnrollment.enroll(user, course_key, check_access=True, due_date=due_date)
